...
Gemini Ai then recommended to replace the makefile with a completely different script, which I have done and pushed to my fork. Additionally, as I am aware that Victoria's device is a Windows laptop, I probed the AI Agent further to verify how this could work for Windows. It seems that as long as the device has WSL and dependencies installed, it should work. I also confirmed from the week 1 setup instructions that windows users were instructed to do this. 
